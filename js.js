let question_arr = ["Кто рассказал Гарри Поттеру, что он волшебник?","На какой факультет Распределяющая шляпа уговаривала поступить Гарри Поттера?","Кто защищает проход в спальню Гриффиндора?","Человек, рождённый в семье волшебников, но без магических способностей, называется:","В Квиддиче есть снитч, квоффл и ..."]
let a1_arr = ["Рон Уизли","Пуффендуй","Сэр Кэдоган","Дементор","Ловец"]
let a2_arr = ["Петуния Дурсль","Слизерин","Почти Безголовый Ник","Магл","Мандрагора"]
let a3_arr = ["Профессор Дамблдор","Гриффиндор","Полная дама","Грязнокровка","Нимбус"]
let a4_arr = ["Хагрид","Когтевран","Миссис Норрис","Сквиб","Бладжер"]
let answer_arr = ["Хагрид","Слизерин","Полная дама","Сквиб","Бладжер"]
